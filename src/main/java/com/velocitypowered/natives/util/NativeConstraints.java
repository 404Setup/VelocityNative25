...
public class NativeConstraints {
  ...
  private static final boolean LINUX_RECAST_ENABLED = Boolean.getBoolean("velocity.linux-recast-enabled")
          || Boolean.parseBoolean(System.getenv("ENABLE_LINUX_RECAST"));
  ...
  static final BooleanSupplier LINUX_X86_64_RECAST = () -> NATIVE_BASE.getAsBoolean()
      && IS_LINUX && IS_AMD64 && LINUX_RECAST_ENABLED;
